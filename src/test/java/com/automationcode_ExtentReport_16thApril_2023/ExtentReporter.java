...
public class ExtentReporter {
	...
	public static ExtentReports generateExtentReport() throws Throwable {
		...
		//Step7: Additional information - System Information and pass it in the Extent Reports
		...
		// C:\Shams\PeopleNTech\Automation\ADVANCED_MAVEN\src\test\java\com\automationcode_ExtentReport_16thApril_2023\config.properties
		FileInputStream ip = new FileInputStream(System.getProperty("user.dir") + "\\src\\test\\java\\com\\automationcode_ExtentReport_16thApril_2023\\config.properties");
		prop.load(ip);
